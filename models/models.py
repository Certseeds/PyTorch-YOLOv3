...
from models.expand_layer import expandLayer
from models.gray_layer import grayLayer
from models.upsample import Upsample
from models.empty_layer import EmptyLayer
...
class Darknet(nn.Module):
    ...
    def forward(self, x, targets=None):
        ...
        for i, (module_def, module) in enumerate(zip(self.module_defs, self.module_list)):
            ...
            if module_def["type"] in ["convolutional", "upsample", "maxpool", "expandlayer", "graylayer"]:
                # print("conv", x.shape)
                x = module(x)
                # print("conv", x.shape)
            elif module_def["type"] == "route":
